...
- The tool must make the **hinge** feel real and consequential.
- It must remain honest about being synthetic.
- It should reward careful thinking rather than reward fast clicking.
- It should feel precise and serious (not polished startup theater).
- The experience should create a moment of genuine clarity about tradeoffs.
...
- A stranger who spends 2–3 minutes with it can clearly explain the hinge in their own words.
- The visualization creates a noticeable "oh" moment.
- The exported packet feels like something you’d actually be willing to send to a technical colleague.

---

## Open Questions (Need Answers)

1. **What feels most "bare and meh" today?**  
   (Visual language? Lack of tension? The hinge not landing emotionally? Overall personality?)

2. **Primary audience for the flagship version?**  
   (AI safety/eval people? Engineers who have to make real decisions? Technical PMs/leaders? Hiring managers in this space?)

3. **Rough time/energy budget?**  
...
- Finalize Phase 1 scope based on answers above.
- Create a design spec for the Hinge Visualization (highest priority).
