...
**Purpose:** Track interesting concepts, features, or side projects for future exploration when time/energy allows.

**Rule:** Add here, then forget until you’re bored or blocked on primary work.
...
- **Status:** Pinned (not started)
- **Date Added:** 2026-05-29

---

## 📦 Template for New Pins
